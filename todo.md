...
## Four Full-Page Theme Options (User clarification Aug 25)
- [x] T267: Preserve `/option1` through `/option4` as existing banner-style reference routes without regression. Completed: the original four routes remain separate components and routes; no existing banner option was replaced.
- [x] T268: Build `/option5` as a complete conversion-first residence marketplace with booking search, featured availability, verified stay cards, district discovery, map area, information sections, and footer. Completed: marketplace hero, featured stay, computed factual counts, residence grid, booking path, interactive map, contact nudge, and shared footer.
- [x] T269: Build `/option6` as a complete premium collection with an immersive editorial journey, curated residence rail, practical booking tools, neighbourhood discovery, policy/trust links, and footer. Completed: editorial opening, collection rail, property detail guidance, interactive map, booking path, contact nudge, and shared footer.
- [x] T270: Build `/option7` as a complete city-guide homepage with trip-planning structure, visual stay comparison, district and map discovery, guest guidance, and footer. Completed: trip-planning hero, comparison grid, guest guidance, interactive map, contact nudge, and shared footer.
- [x] T271: Build `/option8` as a complete warm living-room marketplace with a relaxed residence gallery, quick booking path, practical service information, map/district discovery, and footer. Completed: asymmetric image mosaic, residence cards, booking path, interactive map, contact nudge, and shared footer.
- [x] T272: Verify all four full-page routes in Arabic and English, including responsive behaviour, verified property data, live links to actual property pages, and no fabricated reviews or ratings. Completed: local browser verification of options 5–8 plus Arabic option 8, all 40 tests, and production build pass; every property card/CTA links to an actual property route and no reviews/ratings are rendered.

## Ten Additional Full-Page Theme Options (User request Aug 25)
- [x] T273: Preserve options 1–8 and add a shared full-screen Hero system using verified Horizon images, a 4-second accessible rotating banner, one to three maximum actions, and a fixed visual background layer. Completed: all original options remain routed; options 9–18 share a full-screen Hero that rotates verified property imagery every 4 seconds, limits actions to 1–3, and runs over a fixed ambient property-image background.
- [x] T274: Build full-page options 9–11 with distinct discovery, editorial, and marketplace structures using the shared Hero system. Completed: 09 is a direct marketplace, 10 is an editorial atelier, and 11 is a warm weekender journey.
- [x] T275: Build full-page options 12–15 with distinct itinerary, gallery, concierge, and collection structures using the shared Hero system. Completed: 12 is a stay archive, 13 a city editorial, 14 an image gallery, and 15 a district-first guide.
- [x] T276: Build full-page options 16–18 with distinct comparison, neighbourhood, and immersive portfolio structures using the shared Hero system. Completed: 16 is a comparison workspace, 17 a neighbourhood journey, and 18 an immersive portfolio.
- [x] T277: Verify options 9–18 in both directions, confirm Hero image rotation, preserve reduced-motion behaviour, prevent horizontal overflow, and keep all calls to action tied to real Horizon pages or verified data. Completed: verified options 09, 15, and 18 locally in Arabic; option 09 visibly advanced to a new hero image while retaining its fixed scene. Source includes reduced-motion handling and mobile overflow protections, 41 tests pass, and production build passes.
