...
- [ ] T199: Audit what is visibly served on `horizonstay-sa.com` versus the intended public theme, then complete any missing theme sections or styling without affecting live property, booking, or admin functions.
- [ ] T200: Test and publish the completed theme to the main domain, confirming that the apex domain serves the intended release.
- [ ] T201: Verify the completed theme retains verified property photography, interactive map discovery, live pricing and discount presentation, responsive motion, and reduced-motion accessibility without changing booking or admin workflows.
