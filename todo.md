...
- [ ] T206: Verify the new responsive Arabic/English experience, accessible motion, loading/empty states, existing map/prices/discounts, and release it to the apex domain.
