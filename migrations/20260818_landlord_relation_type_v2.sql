-- Update landlord_data RPC to return separated bookings and nights for owned vs managed
...
BEGIN
  ...
  -- Compute separate totals for owned vs managed (including bookings and nights)
