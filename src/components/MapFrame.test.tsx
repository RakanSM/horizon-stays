...
describe("MapFrame", () => {
  const locations = [
    { id: 1, name_ar: "وحدة كافد", name_en: "KAFD stay", neighborhood: "KAFD", lat: 24.7741, lng: 46.658 },
    { id: 2, name_ar: "وحدة العليا", name_en: "Olaya stay", neighborhood: "Al Olaya", lat: 24.7136, lng: 46.6753 },
  ];
