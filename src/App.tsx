    ...
    <>
      ...
      <footer className="site-footer">
        <div className="container">
          ...
          <div className="copyright">© {new Date().getFullYear()} Horizon Stays — جميع الحقوق محفوظة</div>
        </div>
      </footer>

      <a href={WHATSAPP} target="_blank" rel="noreferrer" className="wa-float" aria-label="واتساب">
