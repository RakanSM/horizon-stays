...
export type ThemePreset = {
  ...
  description: string;
  tokens: ThemeTokens;
  /** Custom hero background image specific to this theme */
  heroImage?: string;
  /** Layout style variant for this theme */
  layoutStyle?: "editorial" | "luxury-grid" | "minimalist" | "futuristic" | "celebration";
...
export const THEMES: ThemePreset[] = [
  {
    id: "royal-gold",
    nameAr: "أفق ريزيدنس",
    nameEn: "Horizon Residence",
    mode: "light",
    description: "هوية أفق التحريرية — خلفية هادئة، مساحات رحبة، ولمسة ذهبية سعودية",
    layoutStyle: "editorial",
    heroImage: "https://bwffhalzuvvmuzjfmdyp.supabase.co/storage/v1/object/public/property-images/kafd-penthouse-3bd-1.webp",
    tokens: {
      bg: "#f7f5f0", bg2: "#eee9df", card: "#fffdf9", card2: "#f7f1e8",
      border: "#ded6ca", text: "#191713", textMuted: "#726c63",
      accent: "#9d6d2b", accent2: "#704817", accentSoft: "rgba(157,109,43,0.12)",
      radius: "16px", fontBody: arabicFonts, fontDisplay: cairoDisplay,
      fontLatin: `"Cormorant Garamond", serif`,
      heroOverlay: "linear-gradient(90deg, rgba(18,15,10,0.76), rgba(18,15,10,0.30) 66%, rgba(18,15,10,0.56))",
      headerBg: "rgba(247,245,240,0.92)", ctaText: "#ffffff",
    },
  },
  {
    id: "midnight-neon",
    ...
    heroImage: "https://bwffhalzuvvmuzjfmdyp.supabase.co/storage/v1/object/public/property-images/sky-lounge-suite-1.webp",
    tokens: {
      bg: "#060a14", bg2: "#0b1325", card: "#0f1a33", card2: "#152447",
  ...
  },
  {
    ...
    layoutStyle: "editorial",
    heroImage: "https://bwffhalzuvvmuzjfmdyp.supabase.co/storage/v1/object/public/property-images/tranquil-stay-luxury-bath-1.webp",
    tokens: {
  ...
  },
  {
    ...
    heroImage: "https://bwffhalzuvvmuzjfmdyp.supabase.co/storage/v1/object/public/property-images/massive-3br-2floors-1.webp",
    tokens: {
  ...
  },
  {
    ...
    heroImage: "https://bwffhalzuvvmuzjfmdyp.supabase.co/storage/v1/object/public/property-images/kafd-penthouse-3bd-2.webp",
    tokens: {
  ...
  },
  {
    ...
    layoutStyle: "editorial",
    heroImage: "https://bwffhalzuvvmuzjfmdyp.supabase.co/storage/v1/object/public/property-images/kafd-penthouse-3bd-3.webp",
    tokens: {
      bg: "#0f0a18", bg2: "#160f23", card: "#1d1430", card2: "#241a3b",
      border: "#31234f", text: "#f3e8ff", textMuted: "#b5a3d4",
      accent: "#c084fc", accent2: "#a855f7", accentSoft: "rgba(192,132,252,0.14)",
      radius: "12px", fontBody: arabicFonts, fontDisplay: cairoDisplay,
      fontLatin: `"Cormorant Garamond", serif`,
      heroOverlay: "linear-gradient(180deg, rgba(15,10,24,0.5), rgba(15,10,24,0.92))",
      headerBg: "rgba(15,10,24,0.85)", ctaText: "#120822",
    },
  },
  {
    id: "ocean-breeze",
    ...
    nameEn: "Ocean Breeze",
    mode: "dark",
    description: "منعش وهادئ — أزرق بحري مع فيروزي مشرق",
    layoutStyle: "luxury-grid",
    heroImage: "https://bwffhalzuvvmuzjfmdyp.supabase.co/storage/v1/object/public/property-images/sky-lounge-suite-2.webp",
    tokens: {
      bg: "#08101a", bg2: "#0d1b2a", card: "#13253b", card2: "#19304e",
      border: "#234166", text: "#e0f2fe", textMuted: "#88b4d8",
      accent: "#38bdf8", accent2: "#0284c7", accentSoft: "rgba(56,189,248,0.14)",
      radius: "8px", fontBody: arabicFonts, fontDisplay: cairoDisplay,
      fontLatin: `"Space Grotesk", sans-serif`,
      heroOverlay: "linear-gradient(180deg, rgba(8,16,26,0.5), rgba(8,16,26,0.92))",
      headerBg: "rgba(8,16,26,0.85)", ctaText: "#061322",
    },
  },
  {
    id: "carbon-ember",
    ...
    nameEn: "Carbon Ember",
    mode: "dark",
    description: "جريء وقوي — رمادي داكن مع برتقالي ناري",
    layoutStyle: "futuristic",
    heroImage: "https://bwffhalzuvvmuzjfmdyp.supabase.co/storage/v1/object/public/property-images/massive-3br-2floors-2.webp",
    tokens: {
      bg: "#111111", bg2: "#191919", card: "#222222", card2: "#2b2b2b",
      border: "#383838", text: "#f5f5f5", textMuted: "#a3a3a3",
      accent: "#f97316", accent2: "#ea580c", accentSoft: "rgba(249,115,22,0.15)",
      radius: "4px", fontBody: arabicFonts, fontDisplay: cairoDisplay,
      fontLatin: `"Space Grotesk", sans-serif`,
      heroOverlay: "linear-gradient(180deg, rgba(17,17,17,0.55), rgba(17,17,17,0.93))",
      headerBg: "rgba(17,17,17,0.86)", ctaText: "#111111",
    },
  },
  {
    id: "sand-dune",
    nameAr: "الكثبان الرملية",
    nameEn: "Sand Dune",
    mode: "light",
    description: "تراثي أصيل — بيج صحراوي مع بني دافئ",
    layoutStyle: "editorial",
    heroImage: "https://bwffhalzuvvmuzjfmdyp.supabase.co/storage/v1/object/public/property-images/tranquil-stay-luxury-bath-2.webp",
    tokens: {
      bg: "#fcf8f2", bg2: "#f4ece1", card: "#ffffff", card2: "#f9f3ea",
      border: "#e6d7c3", text: "#38291c", textMuted: "#8c735a",
      accent: "#b45309", accent2: "#92400e", accentSoft: "rgba(180,83,9,0.12)",
      radius: "8px", fontBody: arabicFonts, fontDisplay: cairoDisplay,
      fontLatin: `"Cormorant Garamond", serif`,
      heroOverlay: "linear-gradient(180deg, rgba(56,41,28,0.4), rgba(56,41,28,0.78))",
      headerBg: "rgba(252,248,242,0.88)", ctaText: "#ffffff",
    },
  },
  {
    id: "aurora-glass",
    ...
    nameEn: "Aurora Glass",
    mode: "dark",
    description: "حديث وشفاف — تأثيرات زجاجية مع ألوان الشفق",
    layoutStyle: "futuristic",
    heroImage: "https://bwffhalzuvvmuzjfmdyp.supabase.co/storage/v1/object/public/property-images/kafd-penthouse-3bd-4.webp",
    tokens: {
      bg: "#0a0c14", bg2: "#101422", card: "#171d33", card2: "#1f2744",
      border: "#2b365c", text: "#f0f4ff", textMuted: "#9aa9d4",
      accent: "#818cf8", accent2: "#6366f1", accentSoft: "rgba(129,140,248,0.15)",
      radius: "16px", fontBody: arabicFonts, fontDisplay: cairoDisplay,
      fontLatin: `"Space Grotesk", sans-serif`,
      heroOverlay: "linear-gradient(180deg, rgba(10,12,20,0.5), rgba(10,12,20,0.92))",
      headerBg: "rgba(10,12,20,0.84)", ctaText: "#0d101d",
    },
  },
  {
    id: "ramadan-nights",
